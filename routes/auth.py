...
from services.authentication import direct_remote_address_key
...
@auth_bp.route("/login")
@limiter.limit(lambda: current_app.config["LOGIN_RATE_LIMIT"], key_func=direct_remote_address_key)
def login():
