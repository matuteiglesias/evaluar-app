...
TUTORING_OUTBOX_LEASE_SECONDS = int(os.environ.get("TUTORING_OUTBOX_LEASE_SECONDS", "300"))
TUTORING_AMBIGUOUS_ALERT_SECONDS = int(os.environ.get("TUTORING_AMBIGUOUS_ALERT_SECONDS", "900"))
...
if TUTORING_EXECUTION_MODE not in {"inline", "queued"}:
    raise ImproperlyConfigured(
        "TUTORING_EXECUTION_MODE must be either 'inline' or 'queued'."
    )
